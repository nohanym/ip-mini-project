...
import {  updateBook } from "../helpers/helpers";
...
const UpdateBook = ({ data, setShowUpdateBook, bookId }) => {
  ...
  return (
    <div className="create-book-form-overlay">
      <div className="create-new-wrapper">
        <div className="form-exit-icon" onClick={() => setShowUpdateBook(null)}>
        ...
        <Formik
          initialValues={{
            ...
            publishDate: new Date(data.publishDate?.toDate()),
            price: data.price,
          }}
